                                                ...
                                                <div className="modal-box max-w-xl p-0 overflow-hidden rounded-3xl">
                                                    ...
                                                    <div className="px-6 pt-6 pb-5 md:px-8">
                                                        ...
                                                        <div className="flex items-center justify-between pr-8">
                                                            ...
                                                            {p.paymentStatus === 'paid' ? (
                                                                <span className="shrink-0 rounded-full bg-[#EDE9FE] text-[#7C3AED] px-3 py-1 text-xs font-semibold">
                                                                    Paid
                                                                </span>
                                                            ) : (
                                                                <span className="shrink-0 rounded-full bg-red-50 text-red-500 px-3 py-1 text-xs font-semibold">
                                                                    Payment due
                                                                </span>
                                                            )}
                                                        </div>
                                                        ...
                                                        <div className="mt-5 flex items-center gap-3">
                                                            <div className="flex-1 min-w-0">
                                                                <p className="text-sm font-semibold text-[#1E1B2E] truncate">{p.senderRegion}</p>
                                                            ...
                                                            <div className="flex-1 min-w-0 text-right">
                                                                <p className="text-sm font-semibold text-[#1E1B2E] truncate">{p.recieverRegion}</p>
                                                    ...
                                                    <div className="max-h-[60vh] overflow-y-auto px-6 py-6 md:px-8 space-y-6 bg-white">
                                                        <div className="grid gap-6 sm:grid-cols-2">
                                                            ...
                                                            <div>
                                                                ...
                                                                {p.pickupInstruction && (
                                                                    <p className="mt-3 text-xs text-[#6B6478] border-l-2 border-[#DCD3F5] pl-3">
                                                                        {p.pickupInstruction}
                                                                    </p>
                                                                )}
                                                            </div>
                                                        ...
                                                        <div className="grid grid-cols-3 gap-4 rounded-2xl bg-[#FAF8FF] border border-[#EDE9FE] px-5 py-4">
                                                            <div>
                                                                <p className="text-xs text-[#6B6478]">Weight</p>
                                                                <p className="mt-0.5 font-semibold text-[#1E1B2E]">{p.parcelWeight} kg</p>
                                                            </div>
                                                            <div>
                                                                <p className="text-xs text-[#6B6478]">Booked</p>
                                                            ...
                                                            <div>
                                                                <p className="text-xs text-[#6B6478]">Cost</p>
                    ...
                    parcels.map((p, index) => (
                        ...
                        >
                            ...
                            <div className="flex items-center justify-end gap-1 pt-2 border-t border-base-200">
                                ...
                                <button
                                    onClick={() => document.getElementById(`my_modal_${index * 100}`).showModal()}
                                    title="View"
                                    className="btn btn-sm btn-square btn-ghost hover:bg-[#7C3AED] hover:text-white transition-colors"
                                >
                                    <FaMagnifyingGlass size={14} />
                                ...
                                <dialog id={`my_modal_${index * 100}`} className="modal">
                                    <div className="modal-box max-w-xl p-0 overflow-hidden rounded-3xl">
                                        {/* Header — route line */}
                                        <div className="px-6 pt-6 pb-5 md:px-8">
                                            <form method="dialog">
